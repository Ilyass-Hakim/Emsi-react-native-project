    ...
    return (
        <SafeAreaView style={styles.container}>
            ...
            <View style={styles.header}>
                <TouchableOpacity onPress={() => onNavPress('profile')} style={styles.profileBtn}>
                    <MaterialIcons name="account-circle" size={28} color={theme.colors.primary} />
                </TouchableOpacity>
            ...
            <TouchableOpacity
                style={styles.fab}
                onPress={() => {
                    console.log('FAB pressed - navigating to register');
                    onNavPress('register');
                }}
            >
